...
fish_names = glob.glob('/Users/arminbahl/Desktop/*_extracted_x_y_ang.npy')

for fish_path in fish_names:
    fish_name = os.path.split(fish_path)[-1][:-22]

    fish_data = np.load(fish_path)

    print(".........................")
    print("This is fish {}".format(fish_name))
